...
graph_modules = [
    ...
    "LA_gesamt_export_import_volumen", "country_comparison", "export_import_growth_countries", "export_import_ranking_graph_of_country", "top10_goods_for_spec_country_all_time" # Hier neu hinzugefügt
]
